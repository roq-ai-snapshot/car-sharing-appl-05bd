  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to Car Sharing Application, your ultimate platform for convenient and sustainable mobility. Experience hassle-free vehicle sharing, anywhere, anytime."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Car Sharing Application, your ultimate platform for convenient and sustainable mobility. Experience hassle-free vehicle sharing, anywhere, anytime.`}
            </Text>
            <Box
